---
description: Las notas de la versión de Área de trabajo de datos 6.2 incluyen nuevas funciones, requisitos de actualización, correcciones de errores y problemas conocidos.
title: Notas de la versión de Área de trabajo de datos 6.1
...
Las notas de la versión de Área de trabajo de datos 6.2 incluyen nuevas funciones, requisitos de actualización, correcciones de errores y problemas conocidos.

## Nuevas funciones {#section-1225066ea8f44cf68e42e019d0bca816}

Área de trabajo de datos 6.2 incluye estas nuevas funciones:

| Funciones  | Descripción |
|--- |--- |
| Árboles de decisión | Los árboles de decisiones son una visualización de análisis predictivo que se utiliza para evaluar las características y relaciones del visitante. El Generador de árboles de decisiones genera una visualización de árboles de decisiones en función de un caso positivo especificado y un grupo de entradas. |
...
| Perfil de atribución | Para analizar rápidamente los valores de atribución (eventos para atribuir responsabilidad por una conversión o venta exitosa), el Área de trabajo de datos proporciona un perfil de atribución basado en reglas con funciones para que el Arquitecto configure los informes de atribución y el Analista para ejecutar los informes. |
...
## Actualizaciones de la interfaz de usuario del cliente de Área de trabajo de datos{#data-workbench-client-ui-updates}

Área de trabajo de datos 6.2 incluye nuevas actualizaciones de la interfaz de usuario en el panel Marcadores, nuevos iconos en la barra de herramientas del espacio de trabajo, la capacidad de arrastrar el espacio de trabajo dentro de una pantalla, nuevas teclas rápidas y actualizaciones de la visualización del gráfico circular.
...
Ahora, Área de trabajo de datos 6.2 reemplaza el texto del espacio de trabajo con iconos. Aún puede pasar el ratón por encima y ver el mensaje de información del objeto que identifica el icono, incluidos **[!UICONTROL File]**, **[!UICONTROL Add]** y **[!UICONTROL Export]**.
...
<table id="table_64BBC67B1BB44B1197FF7E5E7B067696"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Abra la documentación <span class="uicontrol"> de Área de trabajo de datos</span>. <p>También puede pulsar <span class="uicontrol"> &lt;F1&gt;</span> para abrir la ayuda dentro de un espacio de trabajo. </p> </td> 
  </tr> 
  <tr> 
...
Las nuevas teclas rápidas le permiten cambiar el tamaño y volver a configurar las áreas de trabajo entre las vistas de ventana y de página completa.
...
* Adobe Analytics ha actualizado la fuente de datos que alimenta el área de trabajo de datos para aprovechar Profiles and Audiences que se integra con Adobe Experience Cloud. Todos los usuarios del área de trabajo de datos debían preparar su entorno para esta transición para el 21 de abril de 2014.

   Profiles and Audiences se introdujo para proporcionar una vista completa de los clientes en Adobe Analytics. Este nuevo servicio está disponible en Adobe Experience Cloud para aumentar el valor entre las herramientas de análisis y empezar a establecer las bases de estas funciones en Analytics. El nuevo identificador de visitante de Experience Cloud se agregará a la fuente de datos, junto con otras mejoras y mejoras para adaptarse a la nueva fuente de datos y al identificador de visitante global.
