---
description: Una guía rápida para los distintos métodos de transferencia de archivos en DWB.
...
Una guía rápida para los distintos métodos de transferencia de archivos en DWB.

La Administración de transferencia de archivos es un proceso estándar para transferir archivos desde un directorio interno a cualquier otro servidor o movimiento interno de archivos.

## Diferentes métodos de transferencia de archivos {#section-972bb39ba1954c6ebd35f6d042593efe}

1. AWS (Amazon Web Services)

   1. Levante un ticket para instalar la interfaz de línea de comandos de AWS en el servidor si no está instalado (consulte [http://docs.aws.amazon.com/cli/latest/userguide/installing.html](http://docs.aws.amazon.com/cli/latest/userguide/installing.html)).
   1. ¿Cómo comprobar? Intente configurar AWS mediante el símbolo del sistema (consulte [http://docs.aws.amazon.com/cli/latest/userguide/cli-chap-getting-started.html](http://docs.aws.amazon.com/cli/latest/userguide/cli-chap-getting-started.html)).

1. Transfiera archivos del servidor FTP al directorio NAS.

   1. Fuentes sin conexión de FTP desde el servidor ftp al directorio NAS. Los siguientes detalles son obligatorios para FTP.
      ...
      (Los detalles de FTP estarán disponibles en la lista de comprobación del proyecto. Usar el usuario externo de ftp para transferir los archivos)

   1. Utilice la secuencia de comandos ftp_winscp_get.pl adjunta a continuación y programe según los requisitos.
      ...
      >[!NOTE]
      >
      >Si la carpeta de suscripción no está disponible, consulte [Reprocesamiento](../../../home/dwb-implement-overview/dwb-implement-configure/dwb-implement-reprocess-scripting.md#concept-60529e12d6d94386a02c1c6fdedf0295) semanal para descargar la carpeta.

   1. Programe la secuencia de comandos según la disponibilidad de los archivos en ftp_address.
   1. La convención de nombre del archivo debe ser YYYMMDD-&lt;offline_feed_name>-00.*
...
1. Transfiera archivos del directorio NAS al servidor FTP.
   ...
   1. Utilice el script ftp_winscp_put.pl y la programación según los requisitos.
      ...
      Los detalles siguientes son necesarios para ejecutar la secuencia de comandos.
...
1. Transfiera Archivos de un directorio NAS a otro directorio NAS.
   ...
   1. Copie y pegue archivos directamente conectándose a un directorio NAS desde otro. Siga el proceso siguiente:)

      iniciar sesión en el servidor -> ir a Ejecutar -> \\server_name\E$ se abrirá una [nueva carpeta que copiará o moverá directamente los archivos]

   1. Utilice la secuencia de comandos &quot;copy_files.pl&quot; para copiar archivos de un servidor a otro o &quot;move_files.pl&quot; para mover archivos de un servidor a otro. (Estos archivos están disponibles en E:\scripts\Scripository)
