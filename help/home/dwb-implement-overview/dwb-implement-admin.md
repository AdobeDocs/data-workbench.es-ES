...
* Para Errores y alertas: registro de auditoría de integración de TnT, consulte [Exportación del perfil de marketing maestro](https://docs.adobe.com/help/en/data-workbench/using/client/export-data/dwb-crs-integration.html) y [Exportación a los servicios principales de Analytics](https://docs.adobe.com/help/en/data-workbench/using/client/export-data/dwb-crs-integration.html).
