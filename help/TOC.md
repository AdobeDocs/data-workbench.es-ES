...
+ Administración e instalación de servidores {#server-admin-install}
   ...
   + Administración del servidor de Data Workbench {#admin-dwb-server}
      ...
      + Monitorización del espacio en disco {#monitor-disk-space}
         ...
         + [Monitorización del espacio de datos del conjunto de datos](home/c-inst-svr/c-admin-inst-svr/c-mntr-disk-spc/t-mntr-dtst-data-spc.md)
...
+ Sensor {#sensor}
   ...
   + Administración {#admin-sensor}
      + [Administración del sensor](home/c-snsr-ovrvw/admin-sensor/admin-sensor.md)
   ...
   + Archivo Txlogd.conf del sensor {#sensor-txlogd-params}
      ...
      + [Parámetros necesarios](home/c-snsr-ovrvw/sensor-txlogd-params/c-rqrd-prmtrs.md)
   ...
   + Campos de registro de datos de evento {#event-data-record}
      ...
      + [Campos de registro de datos de evento de línea de base](home/c-snsr-ovrvw/c-evnt-data-rcd-flds/c-bsln-evnt-data.md)
   ...
   + Archivos de configuración de muestra {#sample-configs}
      ...
      + [Archivos Txlogd.conf de muestra](home/c-snsr-ovrvw/sensor-sample-configs/txlogd-conf-samples.md)
...
+ Instalación del perfil de supervisión {#monitor}
   ...
   + Espacios de trabajo {#workspace}
      + [Espacios de trabajo para monitorizar el servidor de Data Workbench](home/monitoring-installation/monitoring-profiles/monitoring-profiles.md)
      + [Espacio de trabajo histórico de Data Workbench](home/monitoring-installation/monitoring-profiles/monitoring-historical-using.md)
      + [Espacio de trabajo del estado del perfil de Data Workbench](home/monitoring-installation/monitoring-profiles/monitoring-profile-using.md)
      + [Espacio de trabajo del estado del servidor de Data Workbench](home/monitoring-installation/monitoring-profiles/monitoring-server-using.md)
   + Métricas y dimensiones del perfil de Data Workbench {#monitoring-appendix}
      ...
      + [Métricas en el perfil de monitorización histórica de Data Workbench](home/monitoring-installation/monitoring-appendix/monitoring-hist-metrics.md)
+ Panel {#dashboard}
   ...
   + Tableros {#dashboards}
      ...
      + Visualización de tableros {#viewing-dashboards}
         ...
         + Explorador del panel {#dashboard-browser}
            + [Explorador del panel](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser.md)
            + [Vistas del explorador del panel](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser-views.md)
            + [Búsqueda dentro del explorador del panel](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-searching-within-the-dashboard-browser.md)
         + [Hipervínculo del panel](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-hyperling.md)
      ...
      + [Otras funciones del panel](home/c-adobe-data-workbench-dashboard/c-dashboards/c-other-dashboard-functions.md)
   ...
   + Seleccionar {#select}
      + [Realización de selecciones dentro del panel](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-making-selections-within-the-dashboard.md)
      ...
      + [Aplicar selecciones](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/t-applying-selections.md)
      + [Eliminar de selecciones](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-removing-selections.md)
   ...
   + [Controles de acceso del panel](home/c-adobe-data-workbench-dashboard/c-dashboard-access-controls.md)
...
+ Administrador del panel {#admin}
   ...
   + Comunicación del servidor {#servers-communication}
      + [Comunicación entre el panel y los servidores de Data Workbench](home/c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/c-dashboard-to-data-workbench-servers-communication.md)
   ...
   + Implementación del panel {#dashboard-deployment}
      + [Implementación del panel](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/c-dashboard-deployment.md)
      ...
      + [Añadir clave de licencia del panel](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/t-add-dashboard-license-key.md)
   ...
   + Conexiones del perfil {#profile-connections}
      + [Administración de conexiones del perfil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/c-managing-profile-connections.md)
      + [Añadir una conexión del perfil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-adding-a-profile-connection.md)
      + [Edición de una conexión del perfil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-editing-a-profile.md)
      + [Eliminación de una conexión del perfil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-removing-a-profile-connection.md)
   + Esquema {#schema}
   ...
   + Cuentas de usuario {#user-accounts}
      ...
      + [Añadir una cuenta de usuario](home/c-preparing-for-dashboard-installation/t-managing-user-accounts/t-adding-a-user-account.md)
   ...
   + Grupos de usuarios {#user-groups}
      ...
      + [Eliminación de un grupo de usuario](home/c-preparing-for-dashboard-installation/c-managing-user-groups/t-removing-a-user-group.md)
...
+ Implementación de Data Workbench {#implement}
   + [Implementación de Data Workbench de Adobe](home/dwb-implement-overview/dwb-implement-overview.md)
   ...
   + [Estructuras contables de diseño del esquema](home/dwb-implement-overview/dwb-implement-architecture/dwb-implement-arch-countable.md)
   + [Administración de Data Workbench](home/dwb-implement-overview/dwb-implement-admin.md)
   + Configuración e implementación {#implement-configure}
      ...
      + [Configuración del tiempo del evento](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-event-time.md)
      + [Configuración de la dimensión](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-dim-setup.md)
      + [Configuración de las métricas](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-metric-setup.md)
